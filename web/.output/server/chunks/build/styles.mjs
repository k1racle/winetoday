...
const styles = {
  ...
  "layouts/default.vue": () => import('./default-styles.2p4M51_V.mjs').then(interopDefault),
  "components/AuthDrawer.vue": () => import('./AuthDrawer-styles.DBMG1DI6.mjs').then(interopDefault),
  "components/SiteHeader.vue": () => import('./SiteHeader-styles.DOQpgQq8.mjs').then(interopDefault)
};
