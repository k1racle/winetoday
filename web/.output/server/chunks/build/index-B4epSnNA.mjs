...
import { u as useAsyncData, a as useMediaUrl, _ as __nuxt_component_1$2 } from './sidebar-categories-B7iei0NP.mjs';
...
import { _ as __nuxt_component_1$1, a as __nuxt_component_2, u as useContentMeta } from './SidebarByCategory-DFuBu4iH.mjs';
import { u as useApi, a as useAuth } from './useAuth-2AbBXMNZ.mjs';
...
const __nuxt_component_0 = Object.assign(_sfc_main$5, { __name: "NewsThumbCard" });
...
const __nuxt_component_1 = Object.assign(_sfc_main$4, { __name: "HeroCard" });
...
const __nuxt_component_3 = Object.assign(_sfc_main$3, { __name: "VideoFeatureCard" });
...
const __nuxt_component_4 = Object.assign(_sfc_main$2, { __name: "VideoThumb" });
const ITEM_LIMIT = 7;
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function isTodayInMoscow(date) {
      const d = new Date(date).toLocaleDateString("ru-RU", { timeZone: "Europe/Moscow" });
      const today = (/* @__PURE__ */ new Date()).toLocaleDateString("ru-RU", { timeZone: "Europe/Moscow" });
      return d === today;
    }
    function formatFreshDate(date) {
      if (!date) return "";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(displayedItems), (item, index) => {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="shrink-0 pt-0.5 text-sm font-bold text-accent"${_scopeId}>${ssrInterpolate(formatFreshDate(item.publishedAt || item.createdAt))}</span><div class="min-w-0 flex-1"${_scopeId}><span class="line-clamp-2 text-sm font-medium leading-snug text-foreground group-hover:text-accent"${_scopeId}>${ssrInterpolate(truncatedTitle(item.title, item.materialLabel === "exclusive"))} `);
              ...
              return [
                createVNode("span", { class: "shrink-0 pt-0.5 text-sm font-bold text-accent" }, toDisplayString(formatFreshDate(item.publishedAt || item.createdAt)), 1),
...
const __nuxt_component_6 = Object.assign(_sfc_main$1, { __name: "FreshList" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const [{ data: homepage }, { data: fresh }, { data: latestByCategory }] = ([__temp, __restore] = withAsyncContext(() => Promise.all([
      useAsyncData(
        "homepage",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NewsThumbCard = __nuxt_component_0;
      const _component_HeroCard = __nuxt_component_1;
      const _component_NuxtLink = __nuxt_component_0$1;
      const _component_VideoFeatureCard = __nuxt_component_3;
      const _component_VideoThumb = __nuxt_component_4;
      const _component_ArticleCard = __nuxt_component_1$1;
      const _component_FreshList = __nuxt_component_6;
      ...
      if (unref(topItems).length || unref(mixedItems).length) {
        _push(`<section class="mx-auto max-w-7xl px-4 py-4"><div class="flex flex-col gap-4 lg:flex-row lg:items-start"><div class="order-2 flex w-full flex-col gap-4 lg:w-3/4">`);
        ...
        if (unref(mixedItems).length) {
          _push(`<div class="pt-2 lg:pt-6"><h2 class="mb-6 font-heading text-2xl font-bold">Последние новости</h2><div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-3"><!--[-->`);
        ...
        if (unref(freshItems).length || unref(latestByCategory)?.length) {
          _push(`<aside class="order-first flex w-full flex-col gap-4 lg:order-last lg:w-1/4">`);
...
//# sourceMappingURL=index-B4epSnNA.mjs.map
