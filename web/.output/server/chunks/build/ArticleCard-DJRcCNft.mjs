...
import { a as useAuth } from './useAuth-8H_2G1XE.mjs';

const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "MaterialLabelBadge",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(config)) {
        _push(`<span${ssrRenderAttrs(mergeProps({
          class: ["rounded px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wide text-white", unref(config).color]
        }, _attrs))}>${ssrInterpolate(unref(config).text)}</span>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/MaterialLabelBadge.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_1$1 = Object.assign(_sfc_main$1, { __name: "MaterialLabelBadge" });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    hideExcerpt: { type: Boolean, default: false }
  },
  setup(__props) {
    const props = __props;
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.item.excerpt && __props.variant !== "compact" && !__props.hideExcerpt) {
            ...
            return [
              ...
              createVNode("div", {
                ...
                __props.item.excerpt && __props.variant !== "compact" && !__props.hideExcerpt ? (openBlock(), createBlock("p", {
                  key: 0,
...
export { __nuxt_component_1 as _, __nuxt_component_1$1 as a, useContentMeta as u };
//# sourceMappingURL=ArticleCard-DJRcCNft.mjs.map
