...
import { _ as __nuxt_component_1$1 } from './SocialIcon-DfWVA8HW.mjs';
import { defineComponent, mergeProps, withAsyncContext, computed, withCtx, createTextVNode, unref, toDisplayString, useSSRContext, ref, watch, nextTick, createVNode, openBlock, createBlock } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderTeleport, ssrRenderClass, ssrIncludeBooleanAttr } from 'vue/server-renderer';
import { u as useApi, a as useAuth } from './useAuth-8H_2G1XE.mjs';
import { b as useSeoMeta, a as useRuntimeConfig } from './server.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { u as useAsyncData } from './asyncData-Ct_s6X-a.mjs';
import { S as SIDEBAR_CATEGORY_GROUPS, m as matchSidebarCategory } from './sidebar-categories-DiHE4apX.mjs';
...
function useHeaderCategories() {
  ...
  const headerCategories = computed(() => {
    ...
    return SIDEBAR_CATEGORY_GROUPS.map((group) => matchSidebarCategory(categories.value, group)).filter(Boolean);
  });
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><header class="border-b border-foreground/10 bg-background" data-v-721aaeef><div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4" data-v-721aaeef>`);
      ...
      _push(`<div class="hidden items-center gap-3 md:gap-5 lg:flex" data-v-721aaeef><div class="relative flex items-center" data-v-721aaeef>`);
      if (searchOpen.value) {
        _push(`<form class="absolute right-10 top-0 w-48 lg:w-56" data-v-721aaeef><input${ssrRenderAttr("value", searchQuery.value)} type="text" placeholder="Поиск" class="w-full border border-foreground/10 bg-card py-2 pl-3 pr-4 text-sm outline-none transition focus:border-accent" data-v-721aaeef></form>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button type="button" class="flex h-9 w-9 items-center justify-center rounded-full border border-foreground/10 bg-card text-foreground/60 transition hover:text-foreground" aria-label="Поиск" data-v-721aaeef><svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-721aaeef><path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" data-v-721aaeef></path></svg></button></div>`);
      if (unref(isAuthenticated) && unref(user)) {
        ...
        _push(`<button type="button" class="flex items-center gap-1.5 text-sm text-foreground/80 hover:text-foreground" data-v-721aaeef><svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" data-v-721aaeef><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M18 12h3m0 0-3-3m3 3-3 3" data-v-721aaeef></path></svg><span data-v-721aaeef>Выйти</span></button><!--]-->`);
      } else {
        _push(`<button type="button" class="flex items-center gap-1.5 text-sm text-foreground/80 hover:text-foreground" data-v-721aaeef><svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" data-v-721aaeef><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" data-v-721aaeef></path></svg><span data-v-721aaeef>Войти</span></button>`);
      }
      _push(`<button type="button" class="text-foreground/70 hover:text-foreground" aria-label="Переключить тему" data-v-721aaeef><svg class="h-5 w-5 dark:hidden" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" data-v-721aaeef><path stroke-linecap="round" stroke-linejoin="round" d="M21.752 15.002A9.718 9.718 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 0 0 3 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 0 0 9.002-5.998Z" data-v-721aaeef></path></svg><svg class="hidden h-5 w-5 dark:block" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" data-v-721aaeef><path stroke-linecap="round" stroke-linejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.773-4.227-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" data-v-721aaeef></path></svg></button></div><button type="button" class="flex h-10 w-10 items-center justify-center text-foreground/80 hover:text-foreground lg:hidden" aria-label="Меню" data-v-721aaeef><svg class="h-6 w-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-721aaeef><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" data-v-721aaeef></path></svg></button></div><nav class="hidden border-t border-foreground/10 lg:block" data-v-721aaeef><div class="mx-auto max-w-7xl px-4" data-v-721aaeef><ul class="flex items-center justify-between overflow-x-auto py-3 text-xs font-medium uppercase tracking-wider text-foreground/80 md:text-sm" data-v-721aaeef><li class="shrink-0" data-v-721aaeef>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/news",
      ...
      ssrRenderList(unref(headerCategories), (cat) => {
        _push(`<li class="shrink-0" data-v-721aaeef>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      if (mobileMenuOpen.value) {
        _push(`<div class="fixed inset-0 z-50 flex flex-col bg-background px-4 py-4" data-v-721aaeef><div class="mb-6 flex items-center justify-between border-b border-foreground/10 pb-4" data-v-721aaeef><div class="flex items-center gap-4" data-v-721aaeef><button type="button" class="text-foreground/70 hover:text-foreground" aria-label="Поиск" data-v-721aaeef><svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-721aaeef><path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" data-v-721aaeef></path></svg></button><button type="button" class="text-foreground/70 hover:text-foreground" aria-label="Переключить тему" data-v-721aaeef><svg class="h-5 w-5 dark:hidden" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" data-v-721aaeef><path stroke-linecap="round" stroke-linejoin="round" d="M21.752 15.002A9.718 9.718 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 0 0 3 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 0 0 9.002-5.998Z" data-v-721aaeef></path></svg><svg class="hidden h-5 w-5 dark:block" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" data-v-721aaeef><path stroke-linecap="round" stroke-linejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.773-4.227-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" data-v-721aaeef></path></svg></button>`);
        if (unref(isAuthenticated) && unref(user)) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: "/account",
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" data-v-721aaeef${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" data-v-721aaeef${_scopeId}></path></svg>`);
              } else {
                return [
          ...
          _push(`<button type="button" class="text-foreground/70 hover:text-foreground" aria-label="Войти" data-v-721aaeef><svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" data-v-721aaeef><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" data-v-721aaeef></path></svg></button>`);
        }
        _push(`</div><button type="button" class="text-foreground/70 hover:text-foreground" aria-label="Закрыть" data-v-721aaeef><svg class="h-6 w-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-721aaeef><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" data-v-721aaeef></path></svg></button></div>`);
        if (searchOpen.value) {
          _push(`<form class="mb-6" data-v-721aaeef><input${ssrRenderAttr("value", searchQuery.value)} type="text" placeholder="Поиск" class="w-full border border-foreground/10 bg-card py-3 px-4 text-sm outline-none transition focus:border-accent" data-v-721aaeef></form>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<nav class="flex-1 overflow-y-auto" data-v-721aaeef><ul class="space-y-10" data-v-721aaeef><li data-v-721aaeef>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/",
        ...
        if (socialLinks.value.length) {
          _push(`<div class="mt-auto border-t border-foreground/10 pt-6" data-v-721aaeef><div class="flex items-center justify-between" data-v-721aaeef><!--[-->`);
          ssrRenderList(socialLinks.value, (link) => {
            _push(`<a${ssrRenderAttr("href", link.href)} target="_blank" rel="noopener" class="text-foreground/70 transition hover:text-accent"${ssrRenderAttr("aria-label", link.label)} data-v-721aaeef>`);
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-721aaeef"]]), { __name: "SiteHeader" });
...
function useSiteSeoDefaults() {
  const config = useRuntimeConfig();
  const { getSiteSeo } = useApi();
  const { data: siteSeo } = useAsyncData("site-seo-defaults", () => getSiteSeo(), {
    server: true
  });
  ...
  useSeoMeta({
    ...
    ogImageWidth: defaultImageUrl ? 1200 : void 0,
    ogImageHeight: defaultImageUrl ? 630 : void 0,
    ogImageType: defaultImageUrl ? "image/jpeg" : void 0,
...
//# sourceMappingURL=default-CFGfBfhk.mjs.map
