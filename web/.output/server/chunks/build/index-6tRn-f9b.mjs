import { _ as __nuxt_component_1 } from './ArticleCard-Dy-Yoeqm.mjs';
import { _ as __nuxt_component_2 } from './SidebarByCategory-MZ-H_hzy.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mx-auto max-w-7xl px-4 py-8" }, _attrs))}><h1 class="mb-6 font-heading text-2xl font-bold md:text-3xl">Новости</h1><div class="grid gap-8 lg:grid-cols-4"><div class="lg:col-span-3"><div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3"><!--[-->`);
...
//# sourceMappingURL=index-6tRn-f9b.mjs.map
