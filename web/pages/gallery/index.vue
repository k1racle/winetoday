...
const pageTitle = computed(() =>
  currentPage.value > 1
    ? `Р“Р°Р»РµСЂРµСЏ вЂ” СЃС‚СЂР°РЅРёС†Р° ${currentPage.value} вЂ” Р’РёРЅРѕРґРµР»РёРµ СЃРµРіРѕРґРЅСЏ`
    : 'Р“Р°Р»РµСЂРµСЏ вЂ” Р’РёРЅРѕРґРµР»РёРµ СЃРµРіРѕРґРЅСЏ',
);
const pageDescription = 'Р¤РѕС‚РѕРіР°Р»РµСЂРµРё Рѕ РІРёРЅРµ, РІРёРЅРѕРґРµР»РёРё Рё РІРёРЅРѕРіСЂР°РґР°СЂСЃС‚РІРµ.';
...
useBreadcrumbSchema([
  ...
  { name: 'Р“Р°Р»РµСЂРµСЏ', path: '/gallery' },
]);
...
<template>
  <div class="mx-auto max-w-7xl px-4 py-8">
    <h1 class="mb-6 inline-block border-b-2 border-accent pb-1 font-heading text-4xl font-bold">Р“Р°Р»РµСЂРµСЏ</h1>
