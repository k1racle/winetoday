...
async function onSubmit() {
  ...
  // Demo: имитируем отправку. В проде заменить на $fetch('/api/contact', { method: 'POST', body: form.value })
...
<template>
  <div>
    <!-- Hero -->
    <section class="relative overflow-hidden bg-gradient-to-br from-[#0c3f24] via-[#1a5c3a] to-[#6b9e1f] text-white">
      <div class="absolute inset-0 opacity-10">
        <div class="absolute -right-20 -top-20 h-96 w-96  bg-card/20 blur-3xl" />
        <div class="absolute -bottom-20 -left-20 h-80 w-80  bg-card/10 blur-3xl" />
      </div>
      <div class="relative mx-auto max-w-6xl px-4 py-16 md:py-24">
        <div class="max-w-2xl">
          ...
          <p class="mt-6 text-lg text-white/90">
            Пишите нам о новостях, событиях и идеях. Мы открыты к сотрудничеству, рекламе и обратной связи.
          </p>
        </div>
      </div>
    </section>
            ...
            <form class="mt-8 space-y-5" @submit.prevent="onSubmit">
              <div class="grid gap-5 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    class="w-full  border border-foreground/10 bg-card px-4 py-3 outline-none transition focus:border-accent focus:ring-2 focus:ring-accent/20"
                  >
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  class="w-full resize-none  border border-foreground/10 bg-card px-4 py-3 outline-none transition focus:border-accent focus:ring-2 focus:ring-accent/20"
                />
              </div>
          ...
          <div class=" border border-foreground/5 bg-card p-6 shadow-sm">
            ...
            <div class="mt-5 flex flex-wrap gap-3">
              <a
                ...
                target="_blank"
                rel="noopener"
                class="flex items-center gap-2  bg-[#0088cc]/10 px-4 py-2.5 text-[#0088cc] transition hover:bg-[#0088cc]/20"
              >
