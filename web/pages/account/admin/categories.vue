...
<template>
  <CmsPageShell
    title="Рубрики"
    description="Структура редакционных рубрик, вложенность разделов и управление slug."
  >
          ...
          <Transition name="slide">
            <div v-if="showModal" class="relative mt-8 w-full max-w-md overflow-hidden rounded-lg border border-foreground/10 bg-foreground/5 shadow-2xl">
              <div class="flex items-center justify-between border-b border-foreground/10 px-6 py-4">
                <h2 class="text-lg font-normal">{{ editing ? 'Редактировать рубрику' : 'Добавить рубрику' }}</h2>
              ...
              <div class="space-y-4 p-6">
                ...
                <div>
                  <label class="mb-1 block text-xs font-normal text-foreground/70">Родительская рубрика</label>
