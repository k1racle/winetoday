  ...
  <div class="space-y-6">
    <template v-for="block in props.blocks" :key="block.id">
      <div
        ...
        class="prose prose-lg max-w-none text-foreground dark:prose-invert [&_a]:text-accent [&_a]:underline hover:[&_a]:no-underline [&_h2]:text-2xl [&_h2]:font-normal [&_h2]:mt-6 [&_h2]:mb-4 [&_h3]:text-xl [&_h3]:font-normal [&_h3]:mt-5 [&_h3]:mb-3 [&_ul>li::marker]:text-accent"
