        ...
        <Transition name="slide">
          <div v-if="isOpen" class="relative mt-8 w-full max-w-4xl max-h-[calc(100vh-4rem)] overflow-hidden rounded-lg border border-foreground/10 bg-card shadow-2xl">
            ...
            <div class="overflow-y-auto p-6">
              ...
              <!-- Section -->
              <div class="mb-6">
                <h3 class="mb-3 text-xs font-normal uppercase tracking-wider text-foreground/40">Основная информация</h3>
                <div class="space-y-3">
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    ...
                    <div class="p-4">
                      ...
                      <p class="text-sm font-normal">Сергей Левожинский: «Виноделы все меньше готовы инвестировать в продвижение»</p>
                    </div>
                  </div>
                  ...
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    <div class="border-b border-foreground/10 p-4 sm:border-b-0 sm:border-r">
                      <div class="mb-1 flex items-center gap-2">
                        <span class="h-4 w-1 rounded bg-accent" />
                        <span class="text-sm font-normal">Ссылка (slug)</span>
                        <span class="rounded bg-accent/10 px-1.5 py-0.5 text-[9px] font-normal uppercase text-accent">URL</span>
                      </div>
                    ...
                    <div class="p-4">
                      <p class="mb-1 text-[10px] font-normal uppercase tracking-wider text-accent">Пример URL</p>
              ...
              <div class="mb-6">
                <h3 class="mb-3 text-xs font-normal uppercase tracking-wider text-foreground/40">Настройки публикации</h3>
                <div class="space-y-3">
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    <div class="border-b border-foreground/10 p-4 sm:border-b-0 sm:border-r">
                      <div class="mb-1 flex items-center gap-2">
                        <span class="h-4 w-1 rounded bg-accent" />
                        <span class="text-sm font-normal">Статус</span>
                      </div>
                  ...
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    <div class="border-b border-foreground/10 p-4 sm:border-b-0 sm:border-r">
                      <div class="mb-1 flex items-center gap-2">
                        <span class="h-4 w-1 rounded bg-accent" />
                        <span class="text-sm font-normal">Метка материала</span>
                      </div>
                  ...
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    <div class="border-b border-foreground/10 p-4 sm:border-b-0 sm:border-r">
                      <div class="mb-1 flex items-center gap-2">
                        <span class="h-4 w-1 rounded bg-accent" />
                        <span class="text-sm font-normal">Автор</span>
                      </div>
              ...
              <div class="mb-6">
                <h3 class="mb-3 text-xs font-normal uppercase tracking-wider text-foreground/40">Обложка и медиа</h3>
                <div class="space-y-3">
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    <div class="border-b border-foreground/10 p-4 sm:border-b-0 sm:border-r">
                      <div class="mb-1 flex items-center gap-2">
                  ...
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    <div class="border-b border-foreground/10 p-4 sm:border-b-0 sm:border-r">
                      <div class="mb-1 flex items-center gap-2">
                        <span class="h-4 w-1 rounded bg-accent" />
                        <span class="text-sm font-normal">Источник видео</span>
                      </div>
              ...
              <div class="mb-6">
                <h3 class="mb-3 text-xs font-normal uppercase tracking-wider text-foreground/40">Блоки материала</h3>
                <div class="space-y-3">
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    <div class="border-b border-foreground/10 p-4 sm:border-b-0 sm:border-r">
                      <div class="mb-1 flex items-center gap-2">
                        <span class="h-4 w-1 rounded bg-accent" />
                        <span class="text-sm font-normal">Текстовый блок</span>
                        <span class="rounded bg-accent/10 px-1.5 py-0.5 text-[9px] font-normal uppercase text-accent">rich-text</span>
                      </div>
                  ...
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    <div class="border-b border-foreground/10 p-4 sm:border-b-0 sm:border-r">
                      <div class="mb-1 flex items-center gap-2">
                        <span class="h-4 w-1 rounded bg-accent" />
                        <span class="text-sm font-normal">Галерея / Слайдер</span>
                        <span class="rounded bg-accent/10 px-1.5 py-0.5 text-[9px] font-normal uppercase text-accent">media</span>
                      </div>
                  ...
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    <div class="border-b border-foreground/10 p-4 sm:border-b-0 sm:border-r">
                      <div class="mb-1 flex items-center gap-2">
                        <span class="h-4 w-1 rounded bg-accent" />
                        <span class="text-sm font-normal">Embed HTML</span>
                        <span class="rounded bg-accent/10 px-1.5 py-0.5 text-[9px] font-normal uppercase text-accent">код</span>
                      </div>
              ...
              <div class="mb-6">
                <h3 class="mb-3 text-xs font-normal uppercase tracking-wider text-foreground/40">Рубрики, теги и источники</h3>
                <div class="space-y-3">
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    <div class="border-b border-foreground/10 p-4 sm:border-b-0 sm:border-r">
                      <div class="mb-1 flex items-center gap-2">
                        <span class="h-4 w-1 rounded bg-accent" />
                        <span class="text-sm font-normal">Рубрики и темы</span>
                      </div>
                  ...
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    <div class="border-b border-foreground/10 p-4 sm:border-b-0 sm:border-r">
                      <div class="mb-1 flex items-center gap-2">
                        <span class="h-4 w-1 rounded bg-accent" />
                        <span class="text-sm font-normal">Источники</span>
                      </div>
              ...
              <div class="mb-6">
                <h3 class="mb-3 text-xs font-normal uppercase tracking-wider text-foreground/40">SEO</h3>
                <div class="space-y-3">
                  <div class="grid gap-4 rounded border border-foreground/10 bg-muted sm:grid-cols-2">
                    <div class="border-b border-foreground/10 p-4 sm:border-b-0 sm:border-r">
                      <div class="mb-1 flex items-center gap-2">
                        <span class="h-4 w-1 rounded bg-accent" />
                        <span class="text-sm font-normal">Meta Title / Description</span>
                      </div>
                    ...
                    <div class="p-4">
                      <p class="mb-1 text-[10px] font-normal uppercase tracking-wider text-accent">Пример в Google</p>
